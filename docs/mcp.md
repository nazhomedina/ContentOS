...
| `guardar_maqueta` · `leer_maqueta` | maqueta HTML por pieza (solo HTML y CSS, máx. 2 MB, versión nueva en cada guardado, ligada a la versión del copy). Guardar es solo owner. Ver docs/maquetas.md | `guardar_maqueta` |
