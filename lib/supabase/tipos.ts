...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      piezas: {
        Row: { comunidad_id: string; created_at: string; cta: string | null; estado: string; etapa_embudo: string; etapa_legado: boolean; fecha_objetivo: string | null; fidelidad: string; format_card_id: string | null; formato: string; guion: string | null; hipotesis: Json; id: string; id_publico: string; idea_id: string | null; plataforma: string | null; programa_aprobado: boolean; publicada_en: string | null; requiere_hipotesis: boolean; responsable_id: string | null; serie: string | null; spec_visual: string | null; titulo: string | null; updated_at: string; url: string | null }
