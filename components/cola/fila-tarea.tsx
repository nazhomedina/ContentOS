...
export function FilaTarea({ tarea, mostrarAsignado }: { tarea: TareaEnCola; mostrarAsignado: boolean }) {
  ...
  return (
    <li className={cn("grid gap-2 p-3 md:grid-cols-[minmax(0,1fr)_11rem_7rem_auto] md:items-center md:gap-4", tarea.estado === "hecha" && "opacity-60")}>
      ...
      <div className="flex flex-wrap items-center gap-1.5 text-xs">
        ...
        {tarea.estado === "pendiente" && <span className="text-muted-foreground">pendiente</span>}
      </div>
